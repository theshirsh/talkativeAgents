...
{	       	
	OPTIONS =
	{
		...
		FREQUENCY_STRINGS = {"0.1X","0.3X","0.5X","1X (default)","1.5X","2X"},
	...
	GUARDS =
	{
		...
		-- oneliners when you attack an enemy
		BEGGING = { p_begging, {
		"No, please!",
		"Don't-",
		"No-",
	...
	--	[_M.EVENT_MISS_GUN] = 		{1,{"Slippery sucker"}},	
		...
		[_M.BAD_ESCAPE] = 			{p_badescape,{"We got away this time.","Let's get the hell out of here.","I'm gonna need a drink after this shit.","Why don't it ever go smooth?"}},

...
{	       	
	...
	--	[_M.EVENT_MISS_GUN] = 		{1,{"Slippery sucker"}},	
		...
		[_M.DISGUISE_IN] =		nil,
		[_M.CLOAK_IN] =			{p_cloak,{"Running silent.","In the old days, they'd have burned me as a witch.","Right into thin air.","Whoosh..","And gone.","This thing's more useful than most of the people I work with.","Running silent."}},
	...
	--	[_M.EVENT_MISS_GUN] = 		{1,{"Ok, ok, I'm learning","Dammit! Harder than it looks"}},	
		...
		[_M.STIMMED_BY] =		nil,
		[_M.AWAKENED_BY] =		nil,
		[_M.RESCUER] = 			{p_rescuer,{"Let's hit the road!","Doesn't look too comfy.","Come on!","The sky outside is beautiful. Come, I'll show you."}},
	},

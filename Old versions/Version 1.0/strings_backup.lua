...
{	       	
	...
	[_M.TONY] = {
		...
		[_M.DISGUISE_IN] =		nil,
		[_M.CLOAK_IN] =			{p_cloak,{"Too bad this won't last for long","That's some incredible tech","I could get used to this","The tricky part is not tripping over yourself","It's a shame I didn't have this years ago","You know, Clark's third law says that... \nAlright, maybe now is not the time"}},	

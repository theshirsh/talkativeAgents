...
{	       	
	...
	GUARDS =
	{
		LINES = {
			...
			[_M.CIVILIAN_FLEE] = {p_guard_admin,{
			"Aaaaah!",
	...
	[_M.TONY] = {
		...
		[_M.EXEC_TERMINAL_LOOTED] =	nil,	
		[_M.THREAT_DEVICE_LOOTED] =	{p_loot,{"Very nice. May I keep this? No?","These electronics are quite valuable.","I have a project this could work with!"," < sigh > I suppose Central will insist on selling this."}},
		...
		[_M.MEDGEL] =			{p_medgel,{"Good as new.","Are you alright?","Quiet! We're still in the field.","Welcome back.","So how was the light at the end of the tunnel?"}},
		[_M.WAKE_OTHER] =		nil,
...
"We've made mistakes. We'll fix that."}},
	...
	[_M.PRISM] = {
		...
		[_M.ATTACK_GUN] = 		{p_gun,{"Let's get this over with.","Taking him down.","Time to pay, pig.","Roll credits.","Oh yeah. He's down.","Not the red carpet I want, but it'll do.","They should have been afraid of me all along."}},  	
		[_M.SHOOT_DRONE] =		nil,
		[_M.SHOOT_CAMERA] =		nil,
		...
		[_M.INSTALL_AUGMENT] =		{p_augm,{"I should get some nice mileage out of this.","Just what I've been looking for.","Damn, that stings.","Sweet, an upgrade.","I better not turn into one of those chrome nuts.","Ugh. Sharp won't let me hear the end of this."}},														
		[_M.DISGUISE_IN] =		{1,{"Time to become someone else.","They won't know what hit them.","Let's do some acting.","They always did worry that I took the roles too seriously.","Roll out the red carpet.","First and final take.","Just like the good old days.","This takes me back.","Ahem. Just an ordinary guard...","Hey there, fellow security..."}},
		...
		[_M.OW_INTERVENTION] = 		{p_savefromow,{"Yeah, I don't think so.","Surprise, corporate pig.","Thanks for distracting him.","You okay? I've taken him out.","I don't mind playing hero, but that was way too close."}},
		[_M.SAVED_FROM_OW] = 		{p_ow_saved,{"",}},
	...
	[_M.OLIVIA] = {
		...
		[_M.BLOODY_MISSION] = 		{p_bloodymission,{"It may not be pretty, but the lethal approach is the most effective one, sometimes.","Sometimes, ruthless efficiency is what's called for. Emphasis on \"ruthless\".","They would do well to fear us.",}},
	...
	[_M.DEREK] = {
		...
		[_M.GOOD_ESCAPE] = 			{p_goodescape,{"Everyone in? Splendid, let's go.","Please make sure all limbs are contained in the elevator area before departure.","We certainly made a tidy profit.","Why, I think we might have been almost competent."}},
	...
	[_M.RUSH] = {
		...
		[_M.EVENT_SELECTED] = 	{p_selected,{"Oh great, it's middle management.","What do you want?","Yeah?","Make it quick. I can't wait to get started.","Let me guess. You want me to peek through that door?", " < Yawn > ", "Uh-oh. Here comes the nanny...","Alright, yeah! Let's do this!","Ready to crash this place to the ground?","Let's crash this party!"}}, 
		[_M.ATTACK_GUN] = 		{p_gun,{"I like it when we don't hold back.","Super messy, but at least it's not boring.","No more than they deserve.","I prefer a personal touch.","Taking out the target.","This is what you get."}},  	
		[_M.SHOOT_DRONE] =		nil,
		[_M.SHOOT_CAMERA] =		nil,
		...
		[_M.ATTACK_MELEE] = 		{p_melee,{"I'm sooo good at this.","This is so much faster than stealth.","That was subtle, for me.","Sucker.","Is that what they call armed force? Pathetic.","I expected better.","Next!","Not so tough now, are you?","You better hope I didn't break a nail, buddy."}},					
		[_M.OVERWATCH] = 		{p_ow,{"Got it covered.","All right, I'll wait.","Fine, I'll do it.","Lying in wait.","Prepared to ambush.","I'm watching this area.","Here we go!","Because if there's anything I love, it's standing still.","Fiiine. I'll keep an eye out.",}},				
		[_M.OVERWATCH_MELEE] =		nil,
		
		[_M.GOT_HIT] = 			{p_gothit,{"Like you could... stop me...","What? No...","I don't believe...","Worth it...","Damn... you...","Casse-toi...","Op... operator? So the bad news is...","You... dirty... cheater..."}},			
		[_M.REVIVED] = 			{p_revived,{"Let me at them!","They'll have to try harder than that.","Ugh, fine, I'll buy you a drink later.","Yeah, I'm gonna make them pay."}},					
		[_M.HIJACK] = 			{p_hj,{"There, tech, do your techy thing.","Knowing how this works isn't my job.","Why are we bothering with these, again?","System... you know, whatever.","Uh, open sesame?","I'm pretty sure Derek, like, whispers to these."}},			
		...
		[_M.PIN] = 			{p_pin,{"And here I thought this job would be exciting.","...How long do I have to do this?","I'm not here to babysit.","Enemy pinned. If that helps.","Can I punch him again? Just in case?",}},	
		[_M.INSTALL_AUGMENT] =		{p_augm,{"I swore I was done with these.","Ugh, if I have to.","Ow.","I don't need that. I'm already the best.","You want to turn me into some kind of cybersoldier? Fine, whatever."}},	
		[_M.DISGUISE_IN] =		nil,
	...
	[_M.MONSTER] = {
		...
		[_M.OVERWATCH] = 		{p_ow,{"They won't be passing through here, I assure you.","I'll keep an eye out.","Ambush prepared.","Constant vigilance.",}},
		[_M.OVERWATCH_MELEE] =		nil,
		...
		[_M.SAVED_FROM_OW] = 		{p_ow_saved,{"",}},
		[_M.AGENT_DEATH] = 		{p_agentdeath, {"You knew the risks, friend...","Sigh. Not the first casualty I've seen.","Could we perhaps stop letting them shoot at us? By any chance?","This is why I retired, you know.",}},		
	},	
	...
	[_M.CENTRAL] = {
		...
		[_M.INTERRUPTED] = 		nil,--{p_inter,{"Curses!","Ah."}},				
...
------------
	...
	[_M.MIST] = {
		...
		[_M.EVENT_SELECTED] = 	nil, --{p_selected,{"",}}, 
		[_M.ATTACK_GUN] = 		{p_gun,{"Don't think... don't feel... just do it","I work for Invisible now."}},  	
		[_M.SHOOT_DRONE] =		nil,
		[_M.SHOOT_CAMERA] =		nil,
		[_M.ATTACK_GUN_KO] = 		{p_gunko,{"This will sting. Like a sea anemone.","I wonder what toxin is used here."}}, 								
		...
		[_M.REVIVED] = 			{p_revived,{"No... no... oh, it's you.","I knew I couldn't die.","Ow! Easy on the needle.","Huge syringe. Ugh, what a sight to come back to."}}, 					
		[_M.HIJACK] = 			{p_hj,{"I can do things with this.","Power... yes..."}},  			
		[_M.SAFE_LOOTED] = 		{p_loot,{"I found something.","How much can we buy with this?","Some day I'm going to have to ask someone to explain credits to me."}},				
		[_M.EXEC_TERMINAL_LOOTED] =	nil,	
		[_M.THREAT_DEVICE_LOOTED] =	nil,
	...
	[_M.N_UMI] = {
		...
		[_M.EVENT_SELECTED] = 	{p_selected,{"Operator.","My skills are yours.","I'm receiving.","I hear you."}}, 
		[_M.ATTACK_GUN] = 		{p_gun,{"Die.","I've chosen my side.","Time to get my hands dirty."}}, 	
		[_M.SHOOT_DRONE] =		{p_shootdrone, {"Sorry. But you are just a machine.","You'll live on as scrap metal.",}},
		[_M.SHOOT_CAMERA] =		{p_shootcam,{"Eliminating surveillance.","No more hostile eyes.","They can't watch us now."}},
		[_M.ATTACK_GUN_KO] = 		{p_gunko,{"Dream for a while.","Taking the enemy out.","A nonlethal approach.","A little sting..."}}, 								
		[_M.ATTACK_MELEE] = 		{p_melee,{"Electricity has many uses.","If they could see me now.","If it's any consolation, your brain is more resistant to damage than delicate electronics are.","He's down.","Out before he knew it.",}},

		[_M.OVERWATCH] = 		{p_ow,{"Confirmed.","Overwatch ready.","Area sighted.","I'm on the lookout.",}},		
		[_M.OVERWATCH_MELEE] =		nil,
	
		[_M.GOT_HIT] = 			{p_gothit,{"Remember... remember...","Ow... So cold... and familiar..."}},  			
		[_M.REVIVED] = 			{p_revived,{"Is my drone okay?","Just as well. I'm not ready to give up.","Thanks.",}},  					
		[_M.HIJACK] = 			{p_hj,{"Fuel for my drone army! ...Just kidding.","Power transferred.","Interesting... but unlike some people, I can prioritize."}}, 			
		[_M.SAFE_LOOTED] = 		{p_loot,{"Like drones, credits are just a tool. It's what you use them for.","I've searched it.","Empty now."}},				
		[_M.EXEC_TERMINAL_LOOTED] =	nil,	
		[_M.THREAT_DEVICE_LOOTED] =	nil,
		...
		[_M.PIN] = 			{p_pin,{"Everything has a power-off switch, if you know where to look.","Be still now.","Don't make a fuss.","Are you still out? Good."}},
		...
		[_M.DISGUISE_IN] =		nil,
		[_M.CLOAK_IN] =			{p_cloak,{"I can't help but be awed by this tech.","Holo-optics are a fascinating field.","An advanced model. I can barely feel the heat build-up.",}},
		[_M.MEDGEL] =			{p_medgel,{"You're welcome.","You're lucky I'm here.","Administering first aid.","Thank godness for nanomachines.","Even medicine is all about robotics now.",}},
		[_M.WAKE_OTHER] =		nil,
	...
	[_M.CARMEN] = {
		...
		[_M.SHOOT_CAMERA] =		{p_shootcam,{"No peeking!","Lights out.","I'm not looking to get on camera today.","Paparazzi time-out.",}},
		...
		[_M.INTERRUPTED] = 		{p_loot,{"Drat!","Hey there.","Looks like you've caught a peek of me.","Still have to catch me!","Now comes the chase!"}}, 				
		...
		[_M.MEDGEL] =			{p_medgel,{"You alright?","It's okay, I've got you.","We need to get you out of here...","Take it easy, now.","You got shot. But you're all better now.","You're disoriented. Stay calm and follow my lead.",}},
		[_M.WAKE_OTHER] =		nil,
		...
		[_M.STIMMED_BY] =		nil,
		[_M.AWAKENED_BY] =		nil,
		[_M.RESCUER] = 			{p_rescuer,{"Time to fly the coop.","Care to stretch your legs?","Now for the fun part.","The more, the merrier!","Good to have you onboard.",}},
		...
		[_M.OW_INTERVENTION] = 	{p_savefromow, {"On the house!","Good thing I'm good at playing hero.","And that's why they call me the Scarlet Shadow."},},
		[_M.SAVED_FROM_OW] = 	nil,
		[_M.AGENT_DEATH] = 		nil,		
	},	
	...
	[_M.GOOSE] = {
		...
		[_M.EVENT_SELECTED] = 	{p_selected,{" <HONK> ", " <HONK HONK> ", " <HONK.> ", " <HONK HONK HONK?> ",}},  
		[_M.ATTACK_GUN] = 		nil,	
		[_M.SHOOT_DRONE] =		nil,
		[_M.SHOOT_CAMERA] =		nil,
		[_M.ATTACK_GUN_KO] = 	nil, 
	...
	--	[_M.EVENT_MISS_GUN] = 	nil,	
		[_M.GOT_HIT] = 			{p_gothit,{" < HON- > ", " < H-HONK... HONK... > "}},				
		[_M.REVIVED] = 			{p_revived,{" < coo > ", " < HONK! > ", "..."," < croon > ",}},				
		[_M.HIJACK] = 			{p_hj,{" < HONK! > "," < HONK HONK HONK. > ",}},			
		[_M.SAFE_LOOTED] = 		{p_loot,{" < HONK > ",}},	
		[_M.EXEC_TERMINAL_LOOTED] =	nil,	
		[_M.THREAT_DEVICE_LOOTED] =	nil,		
			
		[_M.INTERRUPTED] = 		{p_inter,{"...", " < HONK? > ",}},					
		[_M.PEEK] = 			nil,								
		
		[_M.PIN] = 			{p_pin,{" < HONK! > ", " < HONK HONK HONK. > ", "...", " < HOOONK! > "}},
		[_M.INSTALL_AUGMENT] =		{p_augm,{" < HONK! > ", " < HONK. > ",}},								
		[_M.DISGUISE_IN] =		nil,
		[_M.CLOAK_IN] =			{p_cloak,{"..."," < (honk) > "}},
		[_M.MEDGEL] =			{p_medgel,{" < HONK! HONK HONK! > ", " -flap flap- ", " < HOOOONK! > -flap- ",}},
		[_M.WAKE_OTHER] =		nil,
		...
		[_M.STIMMED_BY] =		nil,
		[_M.AWAKENED_BY] =		nil,
		[_M.RESCUER] = 			{p_rescuer,{" < HONK. > ", " -flap flap flap- ", " <HONK!> ",}},
		[_M.BAD_ESCAPE] = 			{p_badescape,{" < HONK! > "}},
		[_M.GOOD_ESCAPE] = 			{p_goodescape,{" < HONK HONK! > "}},
		[_M.BLOODY_MISSION] = 		{p_bloodymission,{" < HONK HONK HONK HONK! > -flap flap- "}},
		[_M.ABANDONING_OTHER] = 	{p_abandonedother,{"..."," < HONK... > "}},
		[_M.OW_INTERVENTION] = 		nil,
		[_M.SAVED_FROM_OW] = 		nil,
		[_M.AGENT_DEATH] = 		{p_agentdeath, {"..."," < HONK... HONK. > ", " < H-HONK? HONK?! HOOOONK! > "}},		
	},

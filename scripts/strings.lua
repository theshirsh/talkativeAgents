...
{	       	
	...
	--	[_M.EVENT_SELECTED] = 		{0.2,{"You as ready as I am?","Like old times","Running silent"}},  
		...
		[_M.ATTACK_MELEE] = 		{1,{"Dig fast!","Like a sack of potatoes","Not much of a fight","Might put some ice on that, pal","Looks like the old dog still knows a few tricks"}},					
	...
	[_M.TONY] = {
		...
		[_M.ATTACK_MELEE] = 		{1,{"...And stay down!","Nothing like a little power surge","These things pack quite the punch","A-ha! Triumph"}},  	
		...
		[_M.REVIVED] = 			{1,{"That was unpleasant.","Much appreciated"}},  	
		[_M.HIJACK] = 			{1,{"I don't suppose I could get five minutes with this? ...No?","Let's see what you're made of","I wish I could take my time with this","There's a certain elegance to their systems","Hmpf. Not much of a challenge...","They really make this too easy"}}, 	
		[_M.SAFE_LOOTED] = 		{1,{"What do we have here?","Let's see what's inside","How curious...","Now that's interesting"}},
		[_M.EXEC_TERMINAL_LOOTED] =	nil,	
		[_M.THREAT_DEVICE_LOOTED] =	nil,

		[_M.INTERRUPTED] = 		{1,{"Just a moment","Could be a problem","Would you look at that"}},  	
		[_M.PEEK] = 			{1,{"Information is key","Let's not charge in blind","Scouting area","Surveying the room"}},  	
		
		[_M.PIN] = 			{1,{"Enemy subdued","This one won't be going anywhere","Target pinned","I hope you're comfortable"}},  
		[_M.INSTALL_AUGMENT] =		{1,{"I cannot wait to use this","This seems promising","I've always wanted to try that","Still more human than some people I could name","Efficiency improved"}},
		[_M.DISGUISE_IN] =		nil,
	...
	--	[_M.EVENT_SELECTED] = 		{0.2,{"Almost time for a G and T dont you think?","What do you need, beautiful?"}},  
		...
		[_M.ATTACK_MELEE] = 		{1,{"Boring conversation anyway","That's one less","I think he sprained something"}},		
	...
	--	[_M.EVENT_MISS_GUN] = 		{0.5,{"Guess that was a warning shot?","I.. uh.. missed."}},	
		...
		[_M.HIJACK] = 			{1,{"Uploading virus","You're wasting me on this?","A monkey could do this","The device is ours now"}},
		...
		[_M.PIN] = 			{1,{"Shouldn't I just... shoot him?","Taking prisoners isn't really my bag","...So how's your pension plan?","This could get dull"}},
		[_M.INSTALL_AUGMENT] =		{1,{"So long as it's useful.","This better work","This better not slow me down","More metal or less, it doesn't change anything"}},
		[_M.DISGUISE_IN] =		nil,
		[_M.CLOAK_IN] =			{1,{"Hidden.","Seems a bit like cheating, doesn't it?"}},
		[_M.MEDGEL] =			{1,{"Try to stay on your feet this time","Don't take it personally."}},
		[_M.WAKE_OTHER] =			nil,
	...
	--	[_M.EVENT_SELECTED] = 		{0.2,{"And I thought VillaBank was a hard job.","Keep moving"}},
		...
		[_M.ATTACK_MELEE] = 		{1,{"Zappy would have been nice right now","Facing a lot of resistance right now","Down he goes!","Aaagh... everything's under control","Sparkly","How about you rest for a while?"}},					
		[_M.OVERWATCH] = 		{1,{"Holding here","Watching the way"}},				
		[_M.OVERWATCH_MELEE] =		nil,
	
		[_M.GOT_HIT] = 			{1,{"I guess... I tried... one too many.","Doesn't... hurt... at all...","I guess I had... a good run"}},				
	--	[_M.EVENT_MISS_GUN] = 		{1,{"Ok, ok, I'm learning","Dammit! Harder than it looks"}},	
		...
		[_M.PIN] = 			{1,{"Just stay there, buddy","It will go better for you if you don't move","I could sing you a lullaby while we're here"}},
		[_M.INSTALL_AUGMENT] =		{1,{"Will this fix me?","Another one","I can hear it inside me","This will keep me company","we're all just automatons in the end"}},						
		[_M.DISGUISE_IN] =		nil,
		...
		[_M.MEDGEL] =			{1,{"Shh. Just let them sew you up"}},
		[_M.WAKE_OTHER] =				nil,
		
		[_M.PARALYZER] =		{1,{"Sleep well"}},
		[_M.STIM_SELF] =		nil,
		[_M.STIM_OTHER] =		nil,
		[_M.SELF_STIMMED] =		nil,
		[_M.STIMMED_BY] =		nil,
	...
	--	[_M.EVENT_SELECTED] = 		{0.2,{"You're coming in clear","On the team"}},  
		...
		[_M.SHOOT_DRONE] =		nil,
		[_M.SHOOT_CAMERA] =		nil,
		[_M.ATTACK_GUN_KO] = 		{1,{"Delivering toxin","Clearing things up","Let's open the way"}}, 		
		[_M.ATTACK_MELEE] = 		{1,{"I wish we could solve this by talking, but we can't","Sorry, friend","This will probably sting","Libertad!","El enemigo está bajo control","Awaiting further instructions"}},				
		[_M.OVERWATCH] = 		{1,{"Ok, focused in","I will take care of it"}},			
		[_M.OVERWATCH_MELEE] =		nil,
	...
	--	[_M.EVENT_SELECTED] = 		{0.2,{"Vil get it done.","zey vont get avay vit dis"}},  
		...
		[_M.ATTACK_MELEE] = 		{1,{"...","These guards are not good enough","He is down"}},	
		[_M.OVERWATCH] = 		{1,{"Covering this zone","Will get it done","Standing guard","Ready to intercept"}},				
		[_M.OVERWATCH_MELEE] =		nil,											
	
	--	[_M.EVENT_MISS_GUN] = 		{1,{"Zey have cover"}},		
		[_M.GOT_HIT] = 			{1,{"Do svidanya...","Ne... ne mogu..."}},				
		[_M.REVIVED] = 			{1,{"Spasibo","They cannot stop me"}},				
		[_M.HIJACK] = 			{1,{"Virus installed","Device hacked"}},			
		[_M.SAFE_LOOTED] = 		{1,{"I have captured something"}},	
		[_M.EXEC_TERMINAL_LOOTED] =	nil,	
		[_M.THREAT_DEVICE_LOOTED] =	nil,		
		...
		[_M.PIN] = 			{1,{"I will break you","Stay down.","I have him","He will not move, trust me"}},
	...
	[_M.SHARP] = {
		...
		[_M.ATTACK_MELEE] = 		{1,{"Hardly an opponent","It didn't stand a chance","No match for me","Frail excuse for an organic","Obsolete piece of meat"}},					
		...
		[_M.REVIVED] = 			{1,{"I didn't need your help","I was just resting"}},					
		...
		[_M.PIN] = 			{1,{"Ugh, I think it's still alive","Stop twitching!","Why am I wasting my time here?","This is humiliating","Do I really have to be touching him? Can't I just... no?"}},
		...
		[_M.DISGUISE_IN] =		nil,
		[_M.CLOAK_IN] =			{1,{"Not sure I like this","...Still more attractive than anyone here.","I prefer my enemies to look me in the face before I obliterate them","Undetectable. Yet another on my long list of traits","This hardly seems necessary"}},
		[_M.MEDGEL] =			{1,{"Pathetic."}},
		[_M.WAKE_OTHER] =		nil,
	...
	[_M.PRISM] = {
		...
		[_M.REVIVED] = 			{1,{"They'll pay for that","Back in the floodlights","Think this could stop me? Watch.","Thanks, I guess"}},					
	...
	[_M.OLIVIA] = {
		...
		[_M.PIN] = 			{1,{"I've got him pinned down","Under control"}},
		[_M.INSTALL_AUGMENT] =		{1,{"I suppose that's useful enough","An augment is only as good as its host","I'll make do with this"}},														
		[_M.DISGUISE_IN] =		nil,
		[_M.CLOAK_IN] =			nil,	
		[_M.MEDGEL] =			{1,{"Enough dilly-dallying"}},
		[_M.WAKE_OTHER] =		nil,

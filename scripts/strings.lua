...
{	       	
	...
	[_M.OLIVIA] = {
		...
		[_M.GOT_HIT] = 			{1,{"No! They mustn't...","You... bastard...","No... I still need to...","Damn you..."}},			
		...
		[_M.MEDGEL] =			{1,{"Enough dilly-dallying","Look sharp, we're still in enemy territory","That was a close recovery","You should be fine for now","Do try not to get shot next time","Don't be so sloppy"}},
		[_M.WAKE_OTHER] =		nil,
	...
	[_M.DEREK] = {
		...
		[_M.REVIVED] = 			{1,{"Ugh. Do I even get hazard pay?","A second chance","Let's up the stakes","Back in the game","My thanks, friend","Remind me to thank you later"}},					
		[_M.HIJACK] = 			{1,{"Money is power, but so is data","Let's take a look at this darling","Time to get to work","Ths is what I'm here for","And now the real job begins","Subverting enemy mainframe","Ahhh, now this? This is more like it","Just look at this system - how quaint"}},			
		...
		[_M.PIN] = 			{1,{"Keeping him down","I've always aspired to be some hired muscle","Enemy pinned","Well this could get old rather fast","He's not going anywhere"}},
		...
		[_M.DISGUISE_IN] =		nil,
		[_M.CLOAK_IN] =			{1,{"This is more my style","I'm sure I could tweak this to work longer","Now that's some toy","I like this"}},	
		[_M.MEDGEL] =			{1,{"You are quite fortunate to have modern medicine on your side","There you go, friend","Can you walk? Marvelous","Come on, I'll help you up","Friends don't let friends bleed out on the ground, remember","Stick to the buddy rule next time","You'll have to make that up to me","Let's move along now","Good. Saves me the bother of dragging you."}},
		[_M.WAKE_OTHER] =		nil,
	...
	[_M.DRACO] = {
		...
		[_M.ATTACK_MELEE] = 		{1,{"Bothersome","This is how it feels!","A shocking experience","For your own sake, stay down","...You were saying?","The hunter strikes"}},					
		...
		[_M.REVIVED] = 			{1,{"No rest for the wicked","This chapter is still unfinished","Like a bat out of hell","Someone will pay for that","He shall rise again","Takes more than that to keep me down","Frankly I'm not great at dying","I live!"}},					
		[_M.HIJACK] = 			{1,{"Truly thrilling","Though boring it may be, it's part of the job"}},			
		[_M.SAFE_LOOTED] = 		{1,{"Finders keepers!","Well, hello there","Would be a shame to leave this here","No one will miss it, I am certain","Ours for the taking","A treasure trove"}},					
		[_M.EXEC_TERMINAL_LOOTED] =	nil,	
		[_M.THREAT_DEVICE_LOOTED] =	nil,
		...
		[_M.PIN] = 			{1,{"Don't make me do anything you'll regret","I should have brought a book","If you're lucky I won't be anywhere near when you wake up","So... is the insurance good?","Here we are. Just you, me, and your brain","I can read you like a book","Let's peek between those pages.","The hunter swoops, pinning his prey"}},
		...
		[_M.DISGUISE_IN] =		nil,
		[_M.CLOAK_IN] =			{1,{"Into the shadows","With a light step","Now you see me... now you don't","You saw nothing","Fading into darkness","They won't see me coming","Striking from the shadows"}},
		[_M.MEDGEL] =			{1,{"Rise and shine!","Awaken.","I command you: rise.","This should knit your flesh together.","Next time, do not let them catch you."}},
		[_M.WAKE_OTHER] =		nil,
	...
	[_M.RUSH] = {
		...
		[_M.SHOOT_DRONE] =		nil,
		[_M.SHOOT_CAMERA] =		nil,
		[_M.ATTACK_GUN_KO] = 		{1,{"See? I can do bloodless","I would have rocked the biathlon, if I'd bothered","Perfect aim. As always","He's down, but still in the game","Couches-toi","Taking him out"}},  								
		...
		[_M.GOT_HIT] = 			{1,{"Like you could... stop me...","What? No...","I don't believe...","Worth it...","Damn... you...","Bastard..."}},			
		[_M.REVIVED] = 			{1,{"Let me at them!","They'll have to try harder than that","Ugh, fine, I'll buy you a drink later"}},					
		[_M.HIJACK] = 			{1,{"There, tech, do your techy thing","Knowing how this works isn't my job","Why are we bothering with these, again?","System... you know, whatever","Uh, open sesame?"}},			
		[_M.SAFE_LOOTED] = 		{1,{"Bingo","Smash. Grab. Okay, less smashing than I'd like","Is this all? I thought these people were rich","Money? Well, I won't say no","Hm. Underwhelming."}},					
		[_M.EXEC_TERMINAL_LOOTED] =	nil,	
		[_M.THREAT_DEVICE_LOOTED] =	nil,
		...
		[_M.DISGUISE_IN] =		nil,
		[_M.CLOAK_IN] =			{1,{"So, uh... what now?","Cloak and dagger isn't really my style","Can I do something useful for a change?","Cloak active. For whatever that's worth","Whoo! Pretty fun."}},	
		[_M.MEDGEL] =			{1,{"Next time, I just leave you behind.","See? I can do teamwork!","I don't have time to babysit","Hurts, huh? Suck it up and let's go","You up? Good. Get a move on","This? This is slowing me down.","Clock's ticking","You're less of a dead weight now","Walk it off."}},
	...
	--
		...
		[_M.SHOOT_DRONE] =		nil,
		[_M.SHOOT_CAMERA] =		nil,
		[_M.ATTACK_GUN_KO] = 		{1,{"Guess what? You get to test my new prototype","And here I thought I'd put these days behind me","Now this is more like it","Tranquilising the target. Happy now?"}},  								
		[_M.ATTACK_MELEE] = 		{1,{"Well that takes care of that.","Some things you don't forget. Like riding a bike","Not my preferred weapon, but it works","A little trip down memory lane","Oof. I'm not as young as I used to be, you know!"}},					
		[_M.OVERWATCH] = 		{1,{"They won't be passing through here, I assure you","I'll keep an eye out","Ambush prepared"}},
		[_M.OVERWATCH_MELEE] =		nil,
		
		[_M.GOT_HIT] = 			{1,{"Didn't see that coming","Well that was unwise...","I seem to have made a...","That really... stings...","Gladstone, are you there? I...","No, that's not how it's supposed..."}},	
		[_M.REVIVED] = 			{1,{"Good. I'd rather not have to take one for the team","Oh, splendid","Didn't think you'd be rid of me that easily, did you?","That one's bound to leave a mark","Oh, thank you. A refreshing bout of competence","Ngh. Much appreciated.","I've missed this. Having someone who has my back, I mean.","Urghh. Thank you, I shall be fine now.","Still stings, but this should keep me on my feet until we're out, at least."}},					
		[_M.HIJACK] = 			{1,{"Finally, back to my comfort bubble","Do try to avoid bringing down any heat while I'm busy","Almost makes me want to get back into software","No meowing. Thank goodness","At least that was easy","Now what do we have here?","Hmmmmm... interesting","Ah! I recognise this. I can work with this, yes."}},			
		...
		[_M.PIN] = 			{1,{"Undignified for both of us, isn't it?","What do you take me for - some kind of thug?","I have the enemy pinned, if that helps","I'd much rather be doing something else with my time","A monkey could do this. Yet you hire me?","I have him pinned","}},
		[_M.INSTALL_AUGMENT] =		{1,{"Ooh, I think this one's a limited edition!","Hmph, if I must","Not too shabby","Not inadequate, but I do miss my old suppliers"}},
		[_M.DISGUISE_IN] =		nil,
		[_M.CLOAK_IN] =			{1,{"I do love these new toys","This is incredibly satisfying","This should give them the slip","It is time to... disappear","Whoosh. Ahem, that ought to do it.","More my style."}},
		[_M.MEDGEL] =			{1,{"Oh, good. I wasn't looking forward to having to drag you around.","Do be more careful next time","You're welcome. I'll be sending you the reimbursement bill later","Someone has to pull their weight around here. Might as well be me","Gladstone's always excelled at risking her live assets. You're spared that fate, for now","Don't thank me yet. If you get captured, you're going to wish I'd let you bleed out"}},
		[_M.WAKE_OTHER] =		nil,
	...
	[_M.CENTRAL] = {
		...
		[_M.SHOOT_DRONE] =		nil,
		[_M.SHOOT_CAMERA] =		nil,
		[_M.ATTACK_MELEE] = 		{1,{"Brutal, but effective","This one won't get in our way","The sooner this is over with, the better","Deep in the nit and grit of it","Let's make sure they don't stand in our way","I still remember how to do this"}},					
		...
		[_M.REVIVED] = 			{1,{"Back into the field","I will not be held back by the likes of this","Good. We have work to do","You're earning your keep, agent","Good. Let's continue.","You're only doing your duty, but don't think I don't appreciate that."}},					
		...
		[_M.MEDGEL] =			{1,{"Back on your feet, agent","I need you on your feet. There we go","Pay more attention next time","Keep your head down. I'll get you out of here, I promise."}},
		[_M.WAKE_OTHER] =		nil,
